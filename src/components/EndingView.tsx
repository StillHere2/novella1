...
Он увидел, как над его туманным городом взошло первое теплое солнце. Хтоническая тень растаяла без следа. С улыбкой благодарности за пережитые дни он растворился в ослепительном свете, обретя долгожданный покой. Их связь навсегда осталась в её сердце как светлый маяк, вернувший её к полноценной жизни.`,
        };

      case 'ending_2_eternal_fog':
        return {
...
Она чувствует тепло и покой в своей изоляции, абсолютно не осознавая жуткую правду: за маской собеседника скрывается недобрая потусторонняя сущность. Присосавшись к ее уязвимому разуму, бестелесный паразит медленно оплетает ее сознание, преследуя свои скрытые, чуждые и темные цели.`,
        };
      ...
      case 'ending_3a_saved':
        return {
          ...
          storyText: `Уход собеседника выбил у Алисы последнюю опору. Поднявшись на крышу в холодный дождь, она шагнула к краю...
          
Но неистовая связь сокрушила грань между жизнью и небытием. Материализовавшись в живом мире во плоти, парень выбил дверь на крышу и в последнюю долю секунды схватил Алису за руку, прижав к своему бьющемуся сердцу: «Я живой... и я больше никуда тебя не отпущу».`,
        };
      ...
      case 'ending_3b_too_late':
        return {
          ...
          storyText: `Он пробил оковы небытия и обрел живое тело, задыхаясь от яростного бега по лужам ночного города.
...
Он взлетел по лестнице на крышу, распахнул дверь... но нашел лишь мокрый телефон на парапете. На экране горело его последнее, так и не прочитанное сообщение. Он вернулся к жизни слишком поздно.`,
      ...
      case 'ending_3c_open_finale':
        return {
          ...
          storyText: `Материализовавшись на улицах незнакомого дождливого города, он нашел адрес дома Алисы.
